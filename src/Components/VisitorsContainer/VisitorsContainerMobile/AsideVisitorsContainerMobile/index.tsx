...
export default function AsideVisitorsContainerMobile(){
    ...
    return(
        <aside className={`sm:hidden fixed flex flex-auto top-0 right-0 ${visitorsMobileOpened ? 'translate-x-80%]' : 'translate-x-[90%]'} h-[100vh] m-0 p-0 transition-transform duration-500 z-10`}>
